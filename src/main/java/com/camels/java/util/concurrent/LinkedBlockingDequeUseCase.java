...
/**
 * @Todo {@link java.util.concurrent.LinkedBlockingDeque} 并发环境下安全
 * Created by zhanggc on 2014/10/21.
 */
public class LinkedBlockingDequeUseCase {
    ...
    public static void main(String[] args){
        final LinkedBlockingDequeUseCase useCase = new LinkedBlockingDequeUseCase();
