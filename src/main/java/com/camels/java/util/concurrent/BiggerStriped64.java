 ...
 */
public abstract class BiggerStriped64 extends Number {
     /*
    ...
    /** 2 power Number of CPUS, to place bound on table size */
    static final int NCPU = Runtime.getRuntime().availableProcessors()>>1;
